 ...
 * @version 1.0.0
 */
data class IndexEntry(val name: String, val type: IndexType, val dirty: Boolean, val columns: Array<String>) {
     ...
     * @version 1.0.0
     */
    companion object Serializer : org.mapdb.Serializer<IndexEntry> {
