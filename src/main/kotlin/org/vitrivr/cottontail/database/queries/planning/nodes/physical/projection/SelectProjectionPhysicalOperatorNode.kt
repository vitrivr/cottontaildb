 ...
 * @version 2.1.0
 */
class SelectProjectionPhysicalOperatorNode(input: Physical? = null, fields: List<Pair<Name.ColumnName, Name.ColumnName?>>) : AbstractProjectionPhysicalOperatorNode(input, Projection.SELECT, fields) {
    ...
    override fun partition(p: Int): List<Physical> =
        this.input?.partition(p)?.map { SelectProjectionPhysicalOperatorNode(it, this.fields) } ?: throw IllegalStateException("Cannot partition disconnected OperatorNode (node = $this)")
     ...
     */
    override fun toOperator(tx: TransactionContext, ctx: QueryContext) = SelectProjectionOperator(
