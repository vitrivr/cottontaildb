 ...
 * @version 1.1.0
 */
class EntitySamplePhysicalNodeExpression(val entity: Entity, override val columns: Array<ColumnDef<*>>, val size: Long, val seed: Long = System.currentTimeMillis()) : NullaryPhysicalNodeExpression() {
    init {
    ...
    override fun toOperator(tx: TransactionContext, ctx: QueryContext) = EntitySampleOperator(this.entity, this.columns, this.size, this.seed)
    ...
    /**
     * Calculates and returns the digest for this [EntitySamplePhysicalNodeExpression].
     *
     * @return Digest for this [EntitySamplePhysicalNodeExpression]e
     */
