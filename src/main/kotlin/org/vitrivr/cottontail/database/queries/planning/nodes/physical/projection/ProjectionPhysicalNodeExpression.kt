 ...
 * @version 1.2.0
 */
class ProjectionPhysicalNodeExpression(val type: Projection, val fields: List<Pair<ColumnDef<*>, Name.ColumnName?>>) : UnaryPhysicalNodeExpression() {
    init {
        /* Sanity check. */
    ...
    /**
     * Calculates and returns the digest for this [ProjectionPhysicalNodeExpression].
     *
     * @return Digest for this [ProjectionPhysicalNodeExpression]e
     */
