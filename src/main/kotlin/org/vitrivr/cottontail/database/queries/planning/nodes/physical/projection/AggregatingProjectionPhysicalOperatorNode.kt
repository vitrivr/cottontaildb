 ...
 * @version 2.3.0
 */
class AggregatingProjectionPhysicalOperatorNode(input: OperatorNode.Physical? = null, type: Projection, val fields: List<Pair<Name.ColumnName, Name.ColumnName?>>) : AbstractProjectionPhysicalOperatorNode(input, type) {
