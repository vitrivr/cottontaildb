 ...
 * a set of [LogicalRewriteRule]s to get more sophisticated yet equivalent [NodeExpression]s.
 *
...
class CottontailQueryPlanner(
    ...
    /**
     * Generates a list of equivalent [NodeExpression]s by recursively applying [LogicalRewriteRule]s
     ...
     * Each re-write generated by a [LogicalRewriteRule] results in new candidate, which will in turn be processed.
     *
