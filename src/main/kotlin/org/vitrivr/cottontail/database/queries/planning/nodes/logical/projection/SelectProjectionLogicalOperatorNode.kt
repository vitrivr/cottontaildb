 ...
 * @version 2.1.0
 */
class SelectProjectionLogicalOperatorNode(input: Logical? = null, fields: List<Pair<Name.ColumnName, Name.ColumnName?>>) : AbstractProjectionLogicalOperatorOperator(input, Projection.SELECT, fields) {
