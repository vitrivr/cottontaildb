 ...
 * @version 2.3.0
 */
class AggregatingProjectionLogicalOperatorNode(input: Logical? = null, type: Projection, val fields: List<Pair<Name.ColumnName, Name.ColumnName?>>) : AbstractProjectionLogicalOperatorOperator(input, type) {
