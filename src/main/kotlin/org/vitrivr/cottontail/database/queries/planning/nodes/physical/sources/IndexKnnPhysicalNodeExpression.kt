 ...
 * @version 1.2.0
 */
class IndexKnnPhysicalNodeExpression(val index: Index, val knn: KnnPredicateBinding) : NullaryPhysicalNodeExpression() {
    ...
    override fun toOperator(tx: TransactionContext, ctx: QueryContext): Operator = EntityIndexScanOperator(this.index, this.knn.apply(ctx))
    ...
    override fun digest(): Long {
        ...
        result = 31L * result + this.knn.hashCode()
        return result
    }
}