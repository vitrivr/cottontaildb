 ...
 */
@ExperimentalTime
class CreateEntityOperator(val catalogue: DefaultCatalogue, val name: Name.EntityName, val cols: Array<ColumnDef<*>>): AbstractDataDefinitionOperator(name, "CREATE ENTITY") {
