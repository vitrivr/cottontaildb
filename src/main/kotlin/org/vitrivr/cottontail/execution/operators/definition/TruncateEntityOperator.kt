 ...
 */
@ExperimentalTime
class TruncateEntityOperator(val catalogue: DefaultCatalogue, val name: Name.EntityName): AbstractDataDefinitionOperator(name, "TRUNCATE ENTITY") {
    override fun toFlow(context: TransactionContext): Flow<Record> {
        ...
        return flow {
            val columns = entityTxn.listColumns().map { it.columnDef }.toTypedArray()
