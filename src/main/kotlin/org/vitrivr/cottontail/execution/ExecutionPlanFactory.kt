...
import org.vitrivr.cottontail.execution.tasks.entity.knn.BooleanIndexedKnnTask
import org.vitrivr.cottontail.execution.tasks.entity.knn.EntityIndexedKnnTask
import org.vitrivr.cottontail.execution.tasks.entity.knn.LinearEntityScanKnnTask
import org.vitrivr.cottontail.execution.tasks.entity.knn.ParallelEntityScanKnnTask
        ...
        var last: String = if (whereClause == null && knnClause == null) {
            when (projectionClause.type) {
                ProjectionType.SELECT -> {
                    val internal = plan.addTask(org.vitrivr.cottontail.execution.tasks.entity.boolean.EntityLinearScanTask(entity, projectionClause.columns))
