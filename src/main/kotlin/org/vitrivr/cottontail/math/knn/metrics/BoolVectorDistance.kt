...
enum class BoolVectorDistance : DistanceFunction<BitSet> {
    /**
    ...
    L1 {
        ...
        override fun invoke(a: VectorValue<BitSet>, b: VectorValue<BitSet>, weights: VectorValue<*>): Double {
            var sum = 0.0
            for (i in b.indices) {
        ...
        override fun invoke(a: VectorValue<BitSet>, b: VectorValue<BitSet>): Double {
            var sum = 0.0
            for (i in b.indices) {
    ...
    L2 {
        ...
        override fun invoke(a: VectorValue<BitSet>, b: VectorValue<BitSet>, weights: VectorValue<*>): Double = sqrt(L2SQUARED(a, b, weights))
        override fun invoke(a: VectorValue<BitSet>, b: VectorValue<BitSet>): Double = sqrt(L2SQUARED(a, b))
    },
    ...
    HAMMING {
        override val operations: Int = 1
        override fun invoke(a: VectorValue<BitSet>, b: VectorValue<BitSet>, weights: VectorValue<*>): Double = b.indices.mapIndexed { i, _ -> if (b[i] == a[i]) 0.0f else weights.getAsFloat(i) }.sum().toDouble()
        override fun invoke(a: VectorValue<BitSet>, b: VectorValue<BitSet>): Double = b.indices.mapIndexed { i, _ -> if (b[i] == a[i]) 0.0 else 1.0 }.sum()
    },
    ...
    HAVERSINE {
        ...
        override fun invoke(a: VectorValue<BitSet>, b: VectorValue<BitSet>, weights: VectorValue<*>): Double = this.haversine(a.getAsDouble(0), a.getAsDouble(1), b.getAsDouble(0), b.getAsDouble(1))
        override fun invoke(a: VectorValue<BitSet>, b: VectorValue<BitSet>): Double = this.haversine(a.getAsDouble(0), a.getAsDouble(1), b.getAsDouble(0), b.getAsDouble(1))
