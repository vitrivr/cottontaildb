 ...
 * @version 1.2.0
 */
sealed class InnerProductDistance<T : VectorValue<*>>(type: Type<T>): VectorDistance<T>(Generator.FUNCTION_NAME, type) {
    /**
     ...
     */
    class Complex64Vector(size: Int) : InnerProductDistance<Complex64VectorValue>(Type.Complex64Vector(size)) {
     ...
     */
    class Complex32Vector(size: Int) : InnerProductDistance<Complex32VectorValue>(Type.Complex32Vector(size)) {
     ...
     */
    class DoubleVector(size: Int) : InnerProductDistance<DoubleVectorValue>(Type.DoubleVector(size)) {
     ...
     */
    class FloatVector(size: Int) : InnerProductDistance<FloatVectorValue>(Type.FloatVector(size)) {
     ...
     */
    class LongVector(size: Int) : InnerProductDistance<LongVectorValue>(Type.LongVector(size)) {
     ...
     */
    class IntVector(size: Int) : InnerProductDistance<IntVectorValue>(Type.IntVector(size)) {
