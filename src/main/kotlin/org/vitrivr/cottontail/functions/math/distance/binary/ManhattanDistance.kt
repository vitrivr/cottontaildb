 ...
 * @version 1.2.0
 */
sealed class ManhattanDistance<T : VectorValue<*>>(type: Type<T>): MinkowskiDistance<T>(Generator.FUNCTION_NAME, type, 1) {
     ...
     */
    class Complex64Vector(size: Int) : ManhattanDistance<Complex64VectorValue>(Type.Complex64Vector(size)) {
     ...
     */
    class Complex32Vector(size: Int) : ManhattanDistance<Complex32VectorValue>(Type.Complex32Vector(size)) {
     ...
     */
    class DoubleVector(size: Int) : ManhattanDistance<DoubleVectorValue>(Type.DoubleVector(size)) {
     ...
     */
    class FloatVector(size: Int) : ManhattanDistance<FloatVectorValue>(Type.FloatVector(size)) {
     ...
     */
    class LongVector(size: Int) : ManhattanDistance<LongVectorValue>(Type.LongVector(size)) {
     ...
     */
    class IntVector(size: Int) : ManhattanDistance<IntVectorValue>(Type.IntVector(size)) {
