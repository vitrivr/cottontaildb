 ...
 */
@ExperimentalTime
class ExecuteQueryCommand(client: SimpleClient): AbstractCottontailCommand.Query(client, name = "execute", help = "Counts the number of entries in the given entity. Usage: entity count <schema>.<entity>", expand = false) {
