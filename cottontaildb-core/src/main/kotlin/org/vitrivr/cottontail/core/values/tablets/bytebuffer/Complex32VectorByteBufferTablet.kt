...
/**
 * An [AbstractByteBufferTablet] implementation for [Complex32VectorValue]s.
 *
 * @author Ralph Gasser
 * @version 1.0.0
 */
class Complex32VectorByteBufferTablet(size: Int, logicalSize: Int, direct: Boolean): Tablet.Complex32Vector, AbstractByteBufferTablet<Complex32VectorValue>(size, Types.Complex32Vector(logicalSize), direct) {
