...
/**
 * A [AbstractByteBufferTablet] implementation for [Complex32Value]s.
 *
 * @author Ralph Gasser
 * @version 1.0.0
 */
class Complex32ByteBufferTablet(size: Int, direct: Boolean): Tablet.Complex32, AbstractByteBufferTablet<Complex32Value>(size, Types.Complex32, direct) {
