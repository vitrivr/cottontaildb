...
sealed class Name {
    ...
    object RootName : Name() {
        ...
        fun schema(name: String) = SchemaName(
            NAME_COMPONENT_ROOT,
            name
        )
    }
    ...
    class FunctionName(vararg components: String): Name() {
        ...
        override val components = when {
            ...
            components.size == 2 && components[0].lowercase() == NAME_COMPONENT_ROOT -> arrayOf(
                NAME_COMPONENT_ROOT, components[1].lowercase())
    ...
    /**
     * A [Name] object used to identify a [Schema][org.vitrivr.cottontail.dbms.schema.DefaultSchema].
     */
    ...
    /**
     * A [Name] object used to identify a [Entity][org.vitrivr.cottontail.dbms.entity.DefaultEntity].
     */
    ...
    /**
     * A [Name] object used to identify a [Index][org.vitrivr.cottontail.dbms.index.AbstractIndex].
     */
    ...
    /**
     * A [Name] object used to identify a [Index][org.vitrivr.cottontail.dbms.column.Column].
     */
