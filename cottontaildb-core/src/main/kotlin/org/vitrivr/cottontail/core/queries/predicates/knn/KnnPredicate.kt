package org.vitrivr.cottontail.core.queries.predicates.knn
 ...
 * @version 1.8.0
 */
data class KnnPredicate(val column: ColumnDef<*>, val k: Int, val distance: VectorDistance<*>, val query: Binding) :
    Predicate {

    init {
        require(this.k > 0) { "The value of k for a NNS query cannot be smaller than one (is $k)s!" }
    }
