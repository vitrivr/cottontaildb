 ...
 * The MIT License (MIT)
 *
 * Copyright (c) 2023 by Ralph Gasser
 *
 * This is a basic SQL grammar for Cottontail DB derived from the sqlite grammar found here; https://github.com/bkiers/sqlite-parser
 *
 * Developed by : Ralph Gasser
 */
