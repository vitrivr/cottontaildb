...
data class XodusConfig (
    val logFileSize: Long = 16 * 1024L, /** Determines size of an individual Log file on disk. @see [EnvironmentConfig.LOG_FILE_SIZE] */
    ...
    val logCacheOpenFilesSize: Int = 1024, /** Determines size of the open files cache. @see [EnvironmentConfig.LOG_CACHE_OPEN_FILES] */
