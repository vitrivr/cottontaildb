...
data class XodusConfig (
    ...
    val logCacheReadAhead: Int = 5, /** Determines if and how many pages should be pre-fetched. @see [EnvironmentConfig.LOG_CACHE_READ_AHEAD_MULTIPLE] */
    val storeGetCacheSize: Int = 100, /** Determines size of internal store-get cache. @see [EnvironmentConfig.ENV_STOREGET_CACHE_SIZE] */
    ...
    val useCustomIO: Boolean = true /** Determine whether custom data writer/reader class should be used. Defaults to true*/
) {
    /**
