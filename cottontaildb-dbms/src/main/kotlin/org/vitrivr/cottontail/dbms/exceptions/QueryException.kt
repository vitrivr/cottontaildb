...
open class QueryException(message: String) : DatabaseException(message) {
     ...
     * underlying [org.vitrivr.cottontail.dbms.general.DBO]s. This is usually the case,
     * if [org.vitrivr.cottontail.dbms.general.DBO] names are not spelt correctly.
     *
    ...
    /**
     * [QueryPlannerException] is thrown when [org.vitrivr.cottontail.dbms.queries.planning.CottontailQueryPlanner]
    ...
    /**
     * [UnsupportedPredicateException] is thrown when a [org.vitrivr.cottontail.dbms.queries.Predicate]
     * is applied that is not supported by the [org.vitrivr.cottontail.dbms.general.DBO]  it is applied to.
     *
     * @param message Message describing the issue with the query.
     */
