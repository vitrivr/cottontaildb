 ...
 * @version 3.0.0
 */
class ListLocksPhysicalOperatorNode(override val context: QueryContext): SystemPhysicalOperatorNode("ListLocks") {
    ...
    override fun copy() = ListLocksPhysicalOperatorNode(this.context)
    override fun toOperator(ctx: QueryContext) = ListLocksOperator(ctx)
