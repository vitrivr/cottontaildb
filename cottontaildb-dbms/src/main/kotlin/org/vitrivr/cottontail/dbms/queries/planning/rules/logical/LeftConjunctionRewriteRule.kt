 ...
 * @version 2.0.0
 */
object LeftConjunctionRewriteRule : RewriteRule<OperatorNode.Logical> {
    /**
    ...
    override fun tryApply(node: OperatorNode.Logical, ctx: QueryContext): OperatorNode.Logical? {
        ...
        val ret = FilterLogicalOperatorNode(FilterLogicalOperatorNode(parent, predicate.p1), predicate.p2)
