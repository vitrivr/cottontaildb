 ...
 * @return Store name.
 */
internal fun Name.EntityName.storeName(): String = "${DefaultCatalogue.ENTITY_METADATA_STORE_PREFIX}.${this.schemaName}.${this.entityName}"
 ...
 * @return Store name.
 */
internal fun Name.ColumnName.storeName(): String = "${DefaultCatalogue.COLUMN_METADATA_STORE_NAME}.${this.schemaName}.${this.entityName}.${this.columnName}"
 ...
 * @return Store name.
 */
internal fun Name.IndexName.storeName(): String = "${DefaultCatalogue.INDEX_METADATA_STORE_NAME}.${this.schemaName}.${this.entityName}.${this.indexName}"
