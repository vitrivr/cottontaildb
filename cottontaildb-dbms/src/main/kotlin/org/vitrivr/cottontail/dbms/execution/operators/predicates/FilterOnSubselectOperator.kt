 ...
 * @version 1.2.0
 */
class FilterOnSubselectOperator(val parent: Operator, val subquery: Operator, val predicate: BooleanPredicate) : Operator.MergingPipelineOperator(listOf(parent, subquery)) {
    ...
    override fun toFlow(context: TransactionContext): Flow<Record> = flow {
        ...
        val subqueryFlow = this@FilterOnSubselectOperator.subquery.toFlow(context)
