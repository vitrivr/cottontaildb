 ...
 * @version 1.2.0
 */
object DeferFetchOnPhysicalFetchRewriteRule: RewriteRule {
    /**
     * The [DeferFetchOnPhysicalFetchRewriteRule] can be applied to all [FetchPhysicalOperatorNode]s.
     *
     * @param node The [OperatorNode] to check.
     * @param ctx The [QueryContext]
     * @return True if [DeferFetchOnPhysicalFetchRewriteRule] can be applied to [node], false otherwise.
     */
    override fun canBeApplied(node: OperatorNode, ctx: QueryContext): Boolean = node is FetchPhysicalOperatorNode

    /**
     * Apples this [DeferFetchOnPhysicalFetchRewriteRule] to the provided [OperatorNode].
     *
     * @param node The [OperatorNode] to check.
     * @param ctx The [QueryContext]
