...
@JvmInline
value class ShortVectorValue(val data: ShortArray) : RealVectorValue<Short> {
    ...
    override fun toGrpc(): CottontailGrpc.Literal.Builder
        = CottontailGrpc.Literal.newBuilder().setVectorData(CottontailGrpc.Vector.newBuilder().setIntVector(CottontailGrpc.IntVector.newBuilder().addAllVector(this.map { it.value.toInt() })))
