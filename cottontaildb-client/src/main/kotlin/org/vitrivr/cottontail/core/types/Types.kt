...
sealed class Types<T : Value> {
    ...
    companion object {
        ...
        fun forOrdinal(ordinal: kotlin.Int, logicalSize: kotlin.Int) = when (ordinal) {
            ...
            10 -> Complex32
            11 -> Complex64
            12 -> IntVector(logicalSize)
            13 -> LongVector(logicalSize)
            14 -> FloatVector(logicalSize)
            15 -> DoubleVector(logicalSize)
            16 -> BooleanVector(logicalSize)
